...
- 7/21 覆核議程：
  - 四源審判：techurls / iris(Info Flow) / 36Kr / xAI 查詢詞
    ...
    - 2026-07-19 診斷 + V2EX 域名級排除（commit `85d2ebf`，實測數字
      取排除後首輪真實產出，非模擬）：排除前快照 iris 占 items_ai
      61.8%（110/178），**全數**卡在 has_ai 地板值 0.65、僅 9 條
      有徽章；v2ex.com 網域佔 iris 44.5%（49/110＝items_ai
      27.5%）。排除後首輪實測（`41f2133`，2026-07-19T13:50Z）：
      items_ai 178→**121**，v2ex.com 條目 **0**，iris 裸露規模
      **65 條**（占新 items_ai 分母 53.7%），**100% 仍壓線地板值
