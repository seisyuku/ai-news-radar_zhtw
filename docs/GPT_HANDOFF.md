...
- Local path: `~/workspace/ai-news-radar`
...
/tmp/ai-news-radar-venv/bin/python ~/.codex/skills/.system/skill-creator/scripts/quick_validate.py skills/ai-news-radar
